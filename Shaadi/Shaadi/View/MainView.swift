        ...
        NavigationView {
            VStack {
                ...
                GeometryReader { geometry in
                    ZStack {
                        Circle().fill(Color.gray.opacity(0.3)).frame(width: 150, height: 150)
                            .position(x: geometry.size.width * 0.82, y: geometry.size.height * -0.2)
                        ...
                        Circle().fill(Color.gray.opacity(0.3)).frame(width: 130, height: 130)
